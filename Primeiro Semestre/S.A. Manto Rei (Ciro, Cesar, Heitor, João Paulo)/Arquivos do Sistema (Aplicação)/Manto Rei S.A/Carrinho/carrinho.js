        ...
        for (i=0; i < comprasCarrinho.length; i++) {
           ...
           switch(i) {
                ...
                case 0:
                    ...
                    valorCompra.innerHTML = "R$" + vetorValor[i] + ",00"
                ...
                case 1:
                    ...
                    valorCompra2.innerHTML = "R$" + vetorValor[i] + ",00"
                    valorTotal = valorTotal + vetorValor[i]
                ...
                case 2:
                    ...
                    valorCompra3.innerHTML = "R$" + vetorValor[i] + ",00"
                    valorTotal = valorTotal + vetorValor[i]
                ...
                case 3:
                    ...
                    valorCompra4.innerHTML = "R$" + vetorValor[i] + ",00"
                    valorTotal = valorTotal + vetorValor[i]
                ...
                case 4:
                    ...
                    valorCompra5.innerHTML = "R$" + vetorValor[i] + ",00"
                    valorTotal = valorTotal + vetorValor[i]
                    
                    compraResultado.innerHTML = "R$" + valorTotal + ",00"
